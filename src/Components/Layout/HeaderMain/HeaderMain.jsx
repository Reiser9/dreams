	...
	return(
		<>
			...
			<header className="header header__main">
				...
				<img className="main__circle" src="/assets/img/main-circle.png" alt="Круг" />
				<img className="main__dots" src="/assets/img/dots.png" alt="Точки" />
				<img className="main__air" src="/assets/img/air.png" alt="Самолет" />
					...
					<div className="header__inner">
						...
						<div className="main__inner">
							...
							<p className="main__text">
								Зарабатывай! Путешествуй! Отдыхай!
							</p>

							<button className="button default__button main__button">
								Узнать подробнее
							</button>
						</div>
					</div>
